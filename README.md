...
The questions provided in this repository are the summary of frequently asked questions across numerous companies. We cannot guarantee that these questions will actually be asked during your interview process, nor should you focus on memorizing all of them. The primary purpose is for you to get a sense of basic understanding about some concepts, companies might ask — do not say every question in interview if you don't know the answer to all of them ⁠— that is ok!
